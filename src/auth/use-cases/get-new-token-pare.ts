...
export class GetNewTokenPairUseCase implements ICommandHandler<GetNewTokenPairCommand>{
    ...
    async execute(command: GetNewTokenPairCommand) {
        ...
        await this.commandBus.execute(new RefreshCurrentSessionCommand(command.request, reftrsTokenExpDate, data.deviceId, refreshHash))
