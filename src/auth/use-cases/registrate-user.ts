...
export class RegistrateUserUseCase implements ICommandHandler<RegistrateUserCommand>{
    ...
    async execute(command: RegistrateUserCommand) {
        ...
        return await this.commandBus.execute(new CreateUserCommand(command.data, false));
    }
