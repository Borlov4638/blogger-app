...
export class ChengeCommentLikeStatusUseCase implements ICommandHandler<ChengeCommentLikeStatusCommand>{
    constructor(
    ...
    async execute(command: ChengeCommentLikeStatusCommand) {
        ...
        await this.commentRepo.changeCommentsLikeStatus(command.likeStatus, user, comment)
        return;
    }
}